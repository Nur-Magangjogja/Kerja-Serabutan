        ...
        <div class="max-w-md mx-auto">
                    ...
                    <div class="grid grid-cols-3 divide-x divide-gray-100">
                        ...
                        <div class="p-4 text-center group cursor-pointer hover:bg-gray-50 transition-colors duration-200 rounded-r-2xl">
                            <div class="flex items-center justify-center gap-1">
                                <span class="text-2xl font-bold text-yellow-600 transition-transform duration-300 group-hover:scale-110">{{ $customerRatingAvg }}</span>
            ...
            <div class="px-5 pt-6 pb-24">
                ...
                <div class="grid grid-cols-2 gap-3 mb-4">
                    <!-- Edit Profil -->
                    <a href="{{ route('profile.edit') }}" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 flex flex-col items-center gap-3 hover:shadow-md hover:border-primary-200 transition">
                    ...
                    <!-- Riwayat Bantuan -->
                    <a href="{{ route('customer.helps.history') }}" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 flex flex-col items-center gap-3 hover:shadow-md hover:border-primary-200 transition">
                    ...
                    <!-- Rating & Ulasan -->
                    <a href="{{ auth()->user() && auth()->user()->role === 'mitra' ? route('mitra.ratings') : route('customer.ratings') }}" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 flex flex-col items-center gap-3 hover:shadow-md hover:border-primary-200 transition">
                    ...
                    <!-- Pengaturan -->
                    <a href="{{ route('profile.settings') }}" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-4 flex flex-col items-center gap-3 hover:shadow-md hover:border-primary-200 transition">
