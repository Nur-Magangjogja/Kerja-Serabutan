...
<div class="mb-8">
    ...
    <!-- Sub-navigation Tabs -->
    <div class="flex items-center gap-2 p-1.5 bg-gray-200/50 dark:bg-gray-800/50 backdrop-blur-md rounded-2xl border border-black/[0.06] dark:border-white/[0.08] max-w-fit shadow-xs">
        <!-- Tab: Tema Tampilan -->
