            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between min-h-[40px] text-white">
                    <div class="w-10 flex items-center">
                        <a href="{{ route('mitra.settings') }}" wire:navigate aria-label="Kembali" class="p-2 hover:bg-white/20 rounded-xl transition-colors duration-200 cursor-pointer flex items-center justify-center text-white">
                    ...
                    <div class="text-center flex-1 min-w-0 px-2">
                        <h1 class="text-base font-bold truncate">Ubah Kata Sandi</h1>
                        <p class="text-xs text-white/90 truncate mt-0.5">Perbarui kata sandi untuk keamanan akun Anda</p>
                    </div>
        ...
        <div class="px-5 pt-5 relative z-10">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 p-6">
                <form method="POST" action="{{ route('profile.password.update') }}" class="space-y-5">
                    ...
                    <!-- Submit Button -->
                    <button type="submit"
                        class="w-full py-3.5 rounded-xl text-white font-bold bg-primary-600 hover:bg-primary-700 shadow-sm transition mt-6 cursor-pointer">
                        Ubah Kata Sandi
                    </button>
                </form>
