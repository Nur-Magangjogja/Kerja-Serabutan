<x-mitra-layout>
    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 pb-24">
        ...
        <!-- Settings Content -->
        <div class="px-5 pt-3 relative z-10 space-y-3">
            ...
            <a href="{{ route('mitra.settings.notifications') }}"
                ...
                <div class="flex-1">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Kelola preferensi pemberitahuan akun</p>
                </div>
            ...
            <a href="{{ route('mitra.settings.password') }}"
                ...
                <div class="flex-1">
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Perbarui keamanan kata sandi akun Anda</p>
                </div>
                <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.75" d="M9 5l7 7-7 7" />
                </svg>
