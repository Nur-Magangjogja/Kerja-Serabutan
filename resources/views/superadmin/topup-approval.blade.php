        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-4 flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">{{ $pendingRequests->total() }}</p>
                    <p class="text-xs text-gray-400 dark:text-gray-500">Request menunggu</p>
                </div>
            </div>
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-4 flex items-center gap-3">
                ...
                <div>
                    <p class="text-xs text-gray-500 dark:text-gray-400">Approved Hari Ini</p>
                    <p class="text-2xl font-bold text-gray-900 dark:text-white">0</p>
                    <p class="text-xs text-gray-400 dark:text-gray-500">Transaksi disetujui</p>
                </div>
            </div>
            <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-4 flex items-center gap-3">
                ...
                <div>
                    <p class="text-xs text-gray-500 dark:text-gray-400">Total Nominal</p>
                    <p class="text-xl font-bold text-gray-900 dark:text-white">Rp {{ number_format($pendingRequests->sum('amount'), 0, ',', '.') }}</p>
                    <p class="text-xs text-gray-400 dark:text-gray-500">Menunggu approval</p>
                </div>
            </div>
        </div>
