                                            ...
                                            <div class="mt-3 pt-3 border-t border-gray-100 dark:border-gray-700">
                                                <div class="bg-amber-50/80 dark:bg-amber-950/30 border border-amber-200/60 dark:border-amber-800/40 rounded-xl p-3">
                                                    <div class="flex items-center justify-between gap-2 mb-1">
                                                        <span class="text-xs font-semibold text-gray-700 dark:text-gray-200">Ulasan dari Customer:</span>
                                                        <div class="flex items-center gap-1">
                                                            @for($i = 1; $i <= 5; $i++)
                                                                <svg class="w-3.5 h-3.5 {{ $i <= $customerReview->rating ? 'text-yellow-400' : 'text-gray-300 dark:text-gray-600' }}" fill="currentColor" viewBox="0 0 20 20">
                                                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                                                                </svg>
                                                            @endfor
                                                            <span class="text-xs font-bold text-amber-600 dark:text-amber-400 ml-1">{{ $customerReview->rating }}.0</span>
                                                        </div>
                                                    </div>
                                                    @if($customerReview->review)
                                                        <p class="text-xs text-gray-600 dark:text-gray-300 italic">"{{ $customerReview->review }}"</p>
                                                    @endif
                                                </div>
                                            </div>
                                        @endif
