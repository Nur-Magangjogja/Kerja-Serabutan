    ...
    <div class="max-w-md mx-auto">
            ...
            <div class="relative z-10">
                <div class="flex items-center justify-between min-h-[40px] text-white">
                    ...
                    <div class="w-10 flex items-center justify-end">
                        <a href="{{ route('mitra.withdraw.history') }}" wire:navigate class="p-2 hover:bg-white/20 rounded-xl transition-colors duration-200 text-xs font-bold flex items-center justify-center text-white" title="Riwayat Pencairan" aria-label="Riwayat Pencairan">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="px-5 pt-5 pb-24 space-y-4">
            ...
            <form wire:submit="submit" class="bg-white dark:bg-gray-800 p-5 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-xs space-y-4">
                ...
                <button type="submit" wire:loading.attr="disabled" wire:target="submit" class="w-full py-3 bg-gradient-to-r from-emerald-600 to-teal-600 hover:opacity-95 text-white rounded-xl text-xs font-bold transition shadow-sm cursor-pointer flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed disabled:pointer-events-none">
                    ...
                    <span wire:loading.remove wire:target="submit">Cairkan Dana Sekarang</span>
                    <span wire:loading wire:target="submit">Memproses Pencairan...</span>
                </button>
            </form>
        </div>
    </div>
