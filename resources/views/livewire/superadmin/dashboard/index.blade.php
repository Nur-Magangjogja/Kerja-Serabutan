    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-5">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm p-5">
            ...
            <div class="grid grid-cols-2 gap-2">
                @php
                $quickActions = [
                    ['href' => route('superadmin.users'),            'label' => 'Mitra & Customer', 'color' => 'blue',    'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/>'],
                    ['href' => route('superadmin.cities'),           'label' => 'Kelola Wilayah',  'color' => 'emerald', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>'],
