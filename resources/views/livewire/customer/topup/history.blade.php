                        ...
                        <div class="flex items-start justify-between mb-3">
                            <div class="flex-1">
                                <div class="flex items-center gap-2 mb-1 flex-wrap">
                                    <h3 class="font-bold text-gray-900 dark:text-gray-100 text-sm">{{ $transaction->request_code ?? 'Transaksi Top Up' }}</h3>
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900/60 rounded-xl p-4 space-y-3 border border-gray-100 dark:border-gray-700/60">
                        <div class="flex justify-between text-sm">
                            ...
                            <span class="font-semibold text-gray-900 dark:text-gray-100">{{ $selectedTransaction->request_code ?? 'Transaksi Top Up' }}</span>
                        </div>
                        <div class="flex justify-between text-sm">
