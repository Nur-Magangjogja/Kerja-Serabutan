                ...
                <div>
                    ...
                    <div x-data="{
                        ...
                        <input type="text"
                            ...
                            class="w-full pl-12 pr-4 py-3 text-sm font-bold border border-gray-200 dark:border-gray-600 rounded-xl bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white outline-none focus:ring-2 focus:ring-primary-500">
                    </div>
