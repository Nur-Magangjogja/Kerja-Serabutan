<div class="max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 p-5 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-xs flex items-center justify-between">
        <div>
            <h1 class="text-base font-extrabold text-gray-900 dark:text-white">Riwayat Penarikan Dana (Withdraw)</h1>
            <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Daftar seluruh transaksi pencairan saldo dompet ke rekening Anda</p>
        </div>
        <a href="{{ route('customer.withdraw.form') }}" class="px-4 py-2 bg-primary-600 hover:bg-primary-700 text-white rounded-xl text-xs font-bold transition shadow-xs">
            + Tarik Dana Baru
        </a>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-3xl border border-gray-100 dark:border-gray-700 shadow-xs overflow-hidden">
        @if($withdraws->isEmpty())
            <div class="p-12 text-center">
                ...
                <h3 class="text-sm font-bold text-gray-900 dark:text-white">Belum Ada Riwayat Penarikan Dana</h3>
                <p class="text-xs text-gray-400 mt-1 max-w-xs mx-auto">
                    Anda belum pernah melakukan penarikan saldo dompet ke rekening bank.
                </p>
            </div>
        @else
                ...
                <table class="w-full text-left text-xs">
                    <thead class="bg-gray-50 dark:bg-gray-700/50 text-gray-600 dark:text-gray-300 font-bold uppercase tracking-wider text-[10px] border-b border-gray-100 dark:border-gray-700">
                        <tr>
                            ...
                            <th class="px-4 py-3">Nominal Ditarik</th>
                            <th class="px-4 py-3">Jumlah Diterima</th>
