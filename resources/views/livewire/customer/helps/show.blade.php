        ...
        <div class="bg-white dark:bg-gray-800 rounded-3xl overflow-hidden shadow-xs border border-gray-100 dark:border-gray-700/70">
            ...
            <div class="p-5 space-y-4">
                ...
                <div class="flex gap-2.5 pt-2 border-t border-gray-100 dark:border-gray-700/60">
                    ...
                    @else
                        <a href="{{ route('customer.chat', $help->id) }}" class="flex-1 px-4 py-2.5 bg-[#0098e7] hover:bg-[#0086cc] text-white rounded-xl text-xs font-bold transition shadow-xs text-center flex items-center justify-center gap-1.5 cursor-pointer">
