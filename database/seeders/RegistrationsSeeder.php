...
class RegistrationsSeeder extends Seeder
{
     ...
     * Mengisi riwayat registrasi dan verifikasi data identitas (KTP) pengguna yang telah disetujui.
     */
    public function run(): void
    {
        ...
        $this->command->info('RegistrationsSeeder berhasil membuat riwayat registrasi terverifikasi untuk seluruh customer & mitra.');
    }
}
